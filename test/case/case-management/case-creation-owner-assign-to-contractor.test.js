////////////////////////////////////////////////
//
//  test case : owner create case assign to contractor
//
////////////////////////////////////////////////
...
I.fill( "Case title", "New contractor onboarding to Unee-t" );
...
I.select("Contractor");
// Select occupant
I.click("Email of the Contractor to invite")
I.type(getUniqueTestEmail("contractor"));
